...
nascita, comune di residenza, circoscrizione (se residente a Trento), categoria lavorativa e genere tramite
...
(con più domande). Gli operatori creano le consultazioni in stato \texttt{bozza} e le pubblicano, una volta publicate
diventano votabili a partire dalla data d'inizio;
lo scheduler porta le consultazioni a \texttt{concluso} alla \texttt{data\_fine}. I cittadini possono rispondere alle consultazioni
attive.
...
Data di nascita, comune di residenza, circoscrizione (se residente a Trento), categoria occupazione e genere forniti dal
...
cittadino), genere, circoscrizione e occupazione. Espone queste aggregazioni tramite le API di reportistica.
...
Dati dei cittadini per il calcolo delle aggregazioni al momento del voto.
...
Interrogazione periodica al database per recuperare le consultazioni in stato
